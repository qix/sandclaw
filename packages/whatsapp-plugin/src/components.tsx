      ...
      statusBlock = (
        <div>
          <p style={{ color: colors.warning }}>
            <StatusDot color="yellow" /> <strong>Status:</strong> Waiting for QR
            scan
          </p>
          {waState.qrDataUrl && (
            <div style={{ marginTop: "0.75rem" }}>
              ...
              >
                Open WhatsApp on your phone &rarr; Linked Devices &rarr; Link a
                Device &rarr; Scan this code
              </p>
            </div>
          )}
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <Badge bg={colors.border} fg={colors.muted}>
            {waState.recentConversations.length}
          </Badge>
        </CardHeader>
        <CardBody>
...
export function WhatsAppVerificationRenderer({
  data,
