  ...
  return (
    <div style={{ padding: '1.5rem' }}>
      ...
      <p style={{ color: colors.muted }}>
        ...
        them in a Docker container with network isolation.
      </p>
      <section>
        <h3>Flow</h3>
        <ol style={{ lineHeight: '1.8' }}>
          ...
          <li>Confidante executes pi coding agent in Docker</li>
...
export function BuilderVerificationRenderer({ data }: VerificationRendererProps) {
    ...
    <div>
      ...
      <table style={{ fontSize: '0.82rem', borderCollapse: 'collapse', color: colors.text }}>
        <tbody>
          ...
          {repo && (
            <tr>
              <td style={{ padding: '0.2rem 0.75rem 0.2rem 0', color: colors.muted, fontWeight: 600 }}>Repository</td>
              <td style={{ padding: '0.2rem 0', fontFamily: 'monospace', fontSize: '0.8rem' }}>{repo}</td>
            </tr>
          )}
          {branch && (
            <tr>
              <td style={{ padding: '0.2rem 0.75rem 0.2rem 0', color: colors.muted, fontWeight: 600 }}>Branch</td>
              <td style={{ padding: '0.2rem 0', fontFamily: 'monospace', fontSize: '0.8rem' }}>{branch}</td>
            </tr>
          )}
          {createdAt && (
            <tr>
