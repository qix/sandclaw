...
export function GithubVerificationRenderer({ data }: VerificationRendererProps) {
    ...
    <div>
      ...
      <table style={{ fontSize: '0.82rem', borderCollapse: 'collapse', color: colors.text }}>
        <tbody>
          ...
          <tr>
            <td style={{ padding: '0.2rem 0.75rem 0.2rem 0', color: colors.muted, fontWeight: 600 }}>PR URL</td>
      ...
      {body && (
        <div style={{ marginTop: '1rem' }}>
          <div style={{ fontSize: '0.82rem', color: colors.muted, fontWeight: 600, marginBottom: '0.4rem' }}>
            Description
          </div>
          <div
            style={{
