    ...
    case "waiting_for_token":
      statusBlock = (
        <div>
          ...
          >
            <h4 style={{ marginTop: 0, color: colors.text }}>
              Setup Instructions
            </h4>
            <ol style={{ paddingLeft: "1.25rem", color: colors.muted }}>
              <li>
                Open Telegram and search for{" "}
                <strong style={{ color: colors.text }}>@BotFather</strong>
              </li>
              <li>
                Send{" "}
                <code style={{ color: colors.accent }}>{"/" + "newbot"}</code>{" "}
                and follow the prompts
              </li>
              <li>
                BotFather will reply with a{" "}
                <strong style={{ color: colors.text }}>bot token</strong> (looks
                like{" "}
      ...
      statusBlock = (
        <div>
          <p style={{ color: colors.success }}>
            <StatusDot color="green" /> <strong>Status:</strong> Connected as @
            {tgState.botUsername ?? "unknown"}
          </p>
      ...
      <Card>
        <CardHeader>
          ...
          <Badge bg={colors.border} fg={colors.muted}>
            {tgState.recentConversations.length}
          </Badge>
        </CardHeader>
        <CardBody>
...
export function TelegramVerificationRenderer({
  data,
    ...
    <div>
      ...
      <div
        ...
        style={{
          ...
          border: `1px solid ${colors.accentTintBorder}`,
          color: colors.text,
        }}
      >
        {text}
